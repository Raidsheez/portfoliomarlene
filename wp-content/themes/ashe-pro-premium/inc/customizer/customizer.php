...
*/
	...
	// Boxed Style
	ashe_checkbox_control( 'general', 'boxed_style', esc_html__( 'Enable Boxed Style (Beta)', 'ashe-pro' ), 'refresh', 34 );
	...
	$instagram_style = array(
		'theme' => esc_html__( 'Theme', 'ashe-pro' ),
		'default' => esc_html__( 'Default', 'ashe-pro' ),
	);

	// Instagram Style
	ashe_select_control( 'general', 'instagram_style', esc_html__( 'Style', 'ashe-pro' ), $instagram_style, 'refresh', 36 );
...
*/
	...
	// Show Sidebar Icon
	ashe_checkbox_control( 'main_nav', 'show_sidebar', esc_html__( 'Show Sidebar Icon', 'ashe-pro' ), 'refresh', 16 );
...
*/
	...
	// Show Featured Image
	ashe_checkbox_control( 'single_page', 'show_featured_image', esc_html__( 'Show Featured Image', 'ashe-pro' ), 'refresh', 5 );

	// Show Categories
	ashe_checkbox_control( 'single_page', 'show_categories', esc_html__( 'Show Categories', 'ashe-pro' ), 'refresh', 6 );
...
*/
	...
	// Mobile Menu Text
	ashe_text_control( 'responsive', 'mobile_icon_text', esc_html__( 'Menu Button Text', 'ashe' ), 'refresh', 20 );
...
$fstr = ashe_freemius()->is_trial();
$fspy = ashe_freemius()->is_paying();
$customize_inst = $fstr || $fspy;
function ashe_customize_register_tr( $wp_customize ) { $wp_customize->remove_section('freemius_upsell'); }

if ( $customize_inst ) {
	add_action( 'customize_register', 'ashe_customize_register' );
} else {
	add_action( 'customize_register', 'ashe_customize_register_tr' );
}
...
function ashe_panels_js() {
	...
	wp_enqueue_script( 'ashe-customize-controls', get_theme_file_uri( '/inc/customizer/js/customize-controls.js' ), array(), '3.5.5', true );
