...
*/
	...
	$css .= '
		...
		*/
		...
		.ashe-boxed-style .page-content input.submit:hover,
		...
		.ashe-boxed-style .page-content .blog-pagination.load-more a:hover,
...
*/
	...
	// Instagram Widget
	if ( 'theme' === ashe_options( 'general_instagram_style' ) ) {
		$css .= '
...
if ( class_exists( 'WooCommerce' ) ) {
	...
	$css .= '
		...
		.ashe-boxed-style .page-content .woocommerce a.button:hover,
		...
		.ashe-boxed-style .page-content .woocommerce.widget_price_filter .button:hover,
