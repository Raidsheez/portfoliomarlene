...
<div id="main-nav" class="clear-fix" data-fixed="<?php echo ashe_options( 'main_nav_fixed' ); ?>" data-mobile-fixed="<?php echo ashe_options( 'responsive_nav_fixed' ); ?>">
	...
	<div <?php echo ashe_options( 'general_header_width' ) === 'contained' ? 'class="boxed-wrapper"': ''; ?>>
		...
		<div class="main-nav-icons">
			...
			<?php if ( ashe_options( 'main_nav_dark_mode' ) === true ) : ?>
		...
		<span class="mobile-menu-btn">
			<div>
			<?php
				if ( 'text' === ashe_options('responsive_menu_icon') ) {
					echo '<a>'. esc_html( ashe_options('responsive_mobile_icon_text') ) .'</a>';
				} elseif ( 'hamburger' === ashe_options('responsive_menu_icon') ) {
					echo '<span></span>';
					echo '<span></span>';
					echo '<span></span>';
				} else {
					echo '<i class="fas fa-'. esc_attr( ashe_options( 'responsive_menu_icon' ) ) .'"></i>';
				}
			?>
			</div>
		</span>
